...
public class TIntPoint implements org.apache.thrift.TBase<TIntPoint, TIntPoint._Fields>, java.io.Serializable, Cloneable, Comparable<TIntPoint> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TIntPoint");
  ...
  static {
    schemes.put(StandardScheme.class, new TIntPointStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TIntPointTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TIntPoint.class, metaDataMap);
  }
   ...
   */
  public TIntPoint(TIntPoint other) {
    __isset_bitfield = other.__isset_bitfield;
    this.x = other.x;
    this.y = other.y;
  }

  public TIntPoint deepCopy() {
    return new TIntPoint(this);
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TIntPoint)
      return this.equals((TIntPoint)that);
    return false;
  }

  public boolean equals(TIntPoint that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TIntPoint other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TIntPoint(");
    boolean first = true;
  ...
  private static class TIntPointStandardSchemeFactory implements SchemeFactory {
    public TIntPointStandardScheme getScheme() {
      return new TIntPointStandardScheme();
    }
  }

  private static class TIntPointStandardScheme extends StandardScheme<TIntPoint> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TIntPoint struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TIntPoint struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TIntPointTupleSchemeFactory implements SchemeFactory {
    public TIntPointTupleScheme getScheme() {
      return new TIntPointTupleScheme();
    }
  }

  private static class TIntPointTupleScheme extends TupleScheme<TIntPoint> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TIntPoint struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TIntPoint struct) throws org.apache.thrift.TException {
