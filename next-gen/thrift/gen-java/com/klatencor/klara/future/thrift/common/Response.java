            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.ret = new HashMap<String,String>(2*_map26.size);
                String _key27;
                String _val28;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Response struct) throws org.apache.thrift.TException {
      ...
      if (struct.ret != null) {
        oprot.writeFieldBegin(RET_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, String> _iter30 : struct.ret.entrySet())
          {
      ...
      if (struct.isSetRet()) {
        {
          ...
          for (Map.Entry<String, String> _iter31 : struct.ret.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.ret = new HashMap<String,String>(2*_map32.size);
          String _key33;
          String _val34;
