...
CLASSPATH=""
SERVERCONFIG=$appwhere/conf/client
...
exec $JAVA_EXEC $JAVA_OPTS -DloggingRoot=$appwhere/log -DAPP=JOBCLIENT -DPID=$pid -cp $CLASSPATH\:$SERVERCONFIG org.smartframework.jobhub.client.JobClient