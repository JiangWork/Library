...
public class ActionResult implements org.apache.thrift.TBase<ActionResult, ActionResult._Fields>, java.io.Serializable, Cloneable, Comparable<ActionResult> {
  ...
  static {
    schemes.put(StandardScheme.class, new ActionResultStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ActionResultTupleSchemeFactory());
  }
  ...
  private static class ActionResultStandardSchemeFactory implements SchemeFactory {
    public ActionResultStandardScheme getScheme() {
      return new ActionResultStandardScheme();
    }
  }

  private static class ActionResultStandardScheme extends StandardScheme<ActionResult> {
  ...
  private static class ActionResultTupleSchemeFactory implements SchemeFactory {
    public ActionResultTupleScheme getScheme() {
      return new ActionResultTupleScheme();
    }
  }

  private static class ActionResultTupleScheme extends TupleScheme<ActionResult> {
